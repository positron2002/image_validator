...
# Let the user upload a CSV (or .xlsx if you prefer)
...
if uploaded_file:
    ...
    required_cols = {"Project Id", "Raised Evidence", "Latest Evidence"}
        ...
        with col1:
            if pd.notna(pre_image):
                try:
                    ...
                    st.error("Invalid Pre Image URL/Path")
            else:
        ...
        with col2:
            if pd.notna(post_image):
                try:
                    ...
                    st.error("Invalid Post Image URL/Path")
            else:
    ...
    if st.button("Download Updated File"):
        ...
        with io.BytesIO() as excel_buffer:
            with pd.ExcelWriter(excel_buffer, engine="openpyxl") as writer:
                ...
                quality_col_idx = df_filtered.columns.get_loc("Quality") + 1  # openpyxl is 1-based index
